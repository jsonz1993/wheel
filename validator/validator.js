...
var Validator = function(opts){
    ...
    this.isCallback = opts.callback?true:false;
    this.callback = opts.callback || function(){};
    this.form = _formElm(opts.formelm) || {};
    this.errors = [];
    this.fields = {};
    this.handles = {};
    ...
    // 如果不存在 form 对象
    if(!opts.formelm) return this;

    for (var i = 0, fieldLength = opts.fields.length; i < fieldLength; i++) {
...
Validator.prototype = {
    ...
    validate:function(evt){
        ...
        for (var key in this.fields) {
            // if (this.errors.length && this.isLazy) break;
